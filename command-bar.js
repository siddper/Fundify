...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const commands = [
    ...
    },
    {
      ...
      related: ['2fa', '2 step verification', '2-step verification', '2 factor authentication', 'require password to view transactions', 'require password to see transactions', 'disable fundai access to reminders', "disable fundai's access to reminders", 'disable fundai access to transactions', "disable fundai's access to transactions"]
    },
  ];
